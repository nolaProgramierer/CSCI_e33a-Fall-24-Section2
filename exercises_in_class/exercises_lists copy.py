...
# separated by colons (:). It returns a new sequence.
...
#------------------------------
# 6) Split
# The split() method in Python is used to break a string into a list of substrings  # based on a specified delimiter. If no delimiter is specified, the method splits # the string at whitespace by default. It returns a list of substrings.
